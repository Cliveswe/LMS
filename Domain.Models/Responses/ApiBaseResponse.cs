...
public class ApiActivityNotFoundResponse(string message) : ApiNotFoundResponse(message) { }
public class ApiModuleNotFoundResponse(string message) : ApiNotFoundResponse(message) { }
